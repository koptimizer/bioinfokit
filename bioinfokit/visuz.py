...
class cluster:
    ...
    @staticmethod
    def loadingplot(x=None, y=None, z=None, labels=None, var1=None, var2=None, var3=None, axlabelfontsize=9, arrowcolor='#87ceeb',valphaarrow=1, arrowlinestyle='-',
                axlabelfontname="Arial", figtype='png', r=300, show=False, plotlabels=True, centerlines=True, dim=(6, 4), theme=None):
        if theme == 'dark':
            general.dark_bg()
        if x is not None and y is not None and z is None:
            assert var1 is not None and var2 is not None and labels is not None, "var1 or var2 variable or labels are missing"
            ...
            for i in range(len(x)):
                plt.arrow(0, 0, x[i], y[i], color=arrowcolor, alpha=valphaarrow, ls=arrowlinestyle)
    ...
    def scoreplot(cscore=None, loadings=None, labels=None, var1=None, var2=None, var3=None, axlabelfontsize=9, axlabelfontname="Arial",
